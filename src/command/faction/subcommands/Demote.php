...
class Demote extends FactionCommand
{
    ...
    public function onNormalRun(Player $sender, Session $session, ?string $faction, array $args): void
    {
        ...
        Cache::$factions[$faction]["logs"][time()] = "§9" . $sender->getName() . " §fdemote §9" . $args["membre"] . "§f" . $rank_name;
        Faction::broadcastMessage($faction, "§9[§fF§9] §fLe joueur §9" . $args["membre"] . " §fvient d'être rétogradé §9" . $rank_name);
    }
