        ...
        if ($sender instanceof Player) {
            ...
            $form = new SimpleForm(function (Player $player, mixed $data) use ($session) {
                ...
                if (!Rank::hasRank($player, $kit["rank"])) {
                    ...
                    return;
                } elseif ($session->inCooldown("kit_" . $data) && !$player->hasPermission("pocketmine.group.operator")) {
                ...
                foreach ($kit["items"] as $item) {
                    ...
                    // TODO METTRE LITEM AVEC LES EXTRAVANILLAITEMS
            ...
            foreach (self::getKits() as $key => $value) {
                ...
                if (!Rank::hasRank($sender, $value["rank"])) {
                    $name .= "\n§cNon débloqué";
                } elseif ($session->inCooldown("kit_" . $key) && !$sender->hasPermission("pocketmine.group.operator")) {
