        ...
        if ($sender instanceof Player) {
            ...
            if (in_array($sender->getName(), Vanish::$vanish)) {
                ...
                if ($item->getCustomName() === "§r" . Util::PREFIX . "Vanish §9§l«") {
                    $sender->getInventory()->setItemInHand(VanillaItems::DYE()->setColor(DyeColor::LIGHT_GRAY())->setCustomName("§r" . Util::PREFIX . "Vanish §9§l«"));
                }
            } else {
                foreach (Main::getInstance()->getServer()->getOnlinePlayers() as $player) {
                ...
                if ($item->getCustomName() === "§r" . Util::PREFIX . "Vanish §9§l«") {
                    $sender->getInventory()->setItemInHand(VanillaItems::DYE()->setColor(DyeColor::GREEN())->setCustomName("§r" . Util::PREFIX . "Vanish §9§l«"));
                }
            }
        }
    }
