    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        switch ($args["opt"]) {
            case "start":
                ...
                Base::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Un event §eKOTH POINTS §fvient de commencer ! Vous pouvez vous y téléporter grace à la commande §e/event kothpoints");
                break;
            case "end":
                KothPointsTask::$currentKothPoints = null;

                Base::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "L'event §eKOTH POINTS §fa été arrêté, pas de stuff :/");
                break;
        }
    }
