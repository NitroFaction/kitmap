...
class Domination extends BaseCommand
{
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        switch ($args["opt"]) {
            case "start":
                if (30 > count(Base::getInstance()->getServer()->getOnlinePlayers())) {
                ...
                Base::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Un event §edomination §fvient de commencer ! Vous pouvez vous y téléporter grace à la commande §e/event domination");
                break;
            case "end":
                ...
                Base::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "L'event §edomination §fa été arrêté");
                break;
        }
    }
