...
class ExtraVanillaItems
{
    ...
    public function __construct()
    {
        ...
        self::addItem(VanillaItems::STONE_SHOVEL(), new IrisGlove());
        self::addItem(VanillaItems::STONE_AXE(), new StoneAxe());

        self::addItem(VanillaItems::TURTLE_HELMET(), new Armor(334, 2));

        self::addItem(VanillaItems::GOLDEN_HELMET(), new Armor(1051, 4));
        self::addItem(VanillaItems::GOLDEN_CHESTPLATE(), new Armor(1531, 9));
        self::addItem(VanillaItems::GOLDEN_LEGGINGS(), new Armor(1434, 7));
        self::addItem(VanillaItems::GOLDEN_BOOTS(), new Armor(1243, 4));

        self::addItem(VanillaItems::NETHERITE_HELMET(), new Armor(1402, 5));
        self::addItem(VanillaItems::NETHERITE_CHESTPLATE(), new Armor(2042, 10));
        self::addItem(VanillaItems::NETHERITE_LEGGINGS(), new Armor(1912, 8));
