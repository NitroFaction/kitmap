...
class TeleportationTask extends Task
{
    public function __construct(private readonly Player $player, private readonly Position $position)
    {
        ...
        $player->sendMessage(Util::PREFIX . "Vous allez être téléporté dans §9" . max($time, 0) . " §fseconde(s), veuillez ne pas bouger");
    ...
    public function onRun(): void
    {
        ...
        $player->sendTip(Util::PREFIX . "Teleportation dans: §9" . ($data[0] - time()));
